...
userCtrl.registerUser = function(req, res) {
    ...
    // profileSchema.findOneAndUpdate(req.body, function(err, response) {
    //     if (err) {
    //         res.json({ data: "Error in updating" });
    //     } else {
    //         res.send({ data: "Thank you;" });
    //     }
    // });
    var profile = new profileSchema(req.body);
